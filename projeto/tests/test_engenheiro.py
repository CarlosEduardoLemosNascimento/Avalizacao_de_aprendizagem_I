...
def test_engenheiro_crea_vazio():
    ...
    with pytest.raises(ValueError, match="CREA inválido: o CREA não pode ser vazio."):
        Engenheiro(6, "Pedro", "99999-2222", "pedro@example.com", endereco, Sexo.MASCULINO, EstadoCivil.SOLTEIRO, "1990-11-11", "12345678910", "987654321", "ENG123", Setor.ENGENHARIA, 8000, "")
